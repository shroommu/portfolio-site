...
define('GITHUB_SECRET', 'cpanelgitdeploy');
...
define('EMAIL_RECIPIENT', 'admin@alexakruckenberg.com');
// domain of your website
define('SITE_DOMAIN', 'alexakruckenberg.com');
...
define('KEYPAIR_PASSPHRASE', 'deploy23');
