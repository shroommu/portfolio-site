...
image: "http://alexakruckenberg.com/images/sleepingFox.png"
---

import ConceptArt from "../../assets/images/siteConceptArt.png";
import { Image } from "../../components/blog/styles";
import { Helmet } from "react-helmet-async";

<Helmet>
<title>Alexa Kruckenberg | Blog</title>
<meta name="description" content="Building a site from scratch is a fun adventure, and I'll tell you all about it in this multi-part blog series!" />
<meta name="og:image" content="http://alexakruckenberg.com/images/sleepingFox.png" />
</Helmet>
